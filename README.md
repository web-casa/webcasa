...
基于 [Caddy](https://caddyserver.com) 的反向代理管理 + 插件扩展，最低 2GB 内存即可运行。
...
- **Pro** — Lite + 12 个插件扩展（Docker / 项目部署 / AI 助手 / 数据库 / 文件管理 / 备份 / 监控 / 应用商店 / MCP / 防火墙 / 定时任务 / PHP）
- 用户可按需启用插件，从 Lite 渐进升级到 Pro
