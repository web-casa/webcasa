...
> 版本: 1.1 | 日期: 2026-03-01 | 作者: AI Vibe Coding
>
> 变更记录:
> - v1.1 (2026-03-01): 产品重新定位为 AI-First 面板，精简功能导航从 16 项到 8 项，详见 [04-feature-simplification.md](./04-feature-simplification.md)
...
**Web.Casa** — AI-First 的轻量级服务器管理面板，为 Vibe Coding 时代而生。

核心差异化:
- **AI 原生**: AI 对话作为核心交互方式，传统 UI 作为可视化和确认层
- **极致轻量**: 最低 2GB 内存即可运行全功能面板
- **精简聚焦**: 8 个导航项覆盖核心场景，不堆砌功能

### 1.3 产品形态

> **注意**: 原 Lite/Pro 分层设计已调整。不再区分 Lite 和 Pro，所有功能统一为一个产品，通过精简导航和合并页面降低复杂度。详见 [04-feature-simplification.md](./04-feature-simplification.md)。
...
│                                              │
│  扩展层 (插件):                                │
│  Docker Compose │ 项目部署 │ AI 助手           │
│  文件管理器 │ Web 终端                          │
│                                              │
│  导航: 8 项 (Dashboard/Hosts/Caddyfile/       │
│        Docker/Deploy/Files/Terminal/Settings)  │
└──────────────────────────────────────────────┘
```
